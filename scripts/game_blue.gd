...
var red_game_script = load("res://scripts/game_red.gd")
var blue_game_script = load("res://Scenes/game_blue.tscn")
var red_game_scene = load("res://Scenes/game_red.tscn")
...
var red_airplane_scene = load("res://PieceNodes/blue_airplane_node.tscn")
...
var blue_missile_scene = load("res://PieceNodes/red_missile_node.tscn")
